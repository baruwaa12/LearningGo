...
// These are all the possible poker pairs you can have
const (
	HighCard = iota + 1
	Pair
	TwoPair
...
// These are all the possible types of cards you can have
const (
	Hearts   = '\u2661' // ♡
	Diamonds = '\u2662' // ♢
	Spades   = '\u2664' // ♤
...
// These are all the values for the 4 highest card types in a deck
const (
	J = 11
	Q = 12
	K = 13
...
// SetRank function to determine the card rank
...
// SetSuit function to determine if card is a diamond or...
